...
while opcion != "4":
  ...
  if opcion == "1":
    ...
    while opc1 != "7":
      ...
      if opc1 == "1":
        ...
        input("Elemento ingresado, presione ENTER para continuar...")
      ...
      #mostrar elementos de la lista
        ...
        if len(datos.lista) == 0:
          ...
          while True:
              try:
                eliminado=int(input("Ingrese la posición del elemento que desea eliminar: "))
                datos.eliminarElemento(eliminado)
                break
              except ValueError:
          ...
          while True:
            try:
              ...
              if pos < 0 or pos > (len(datos.lista)+1):
                gotoxy(0,2);print("Esa posición no existe......."+" "*60);time.sleep(1)
                print("\033[3A")
              else:
  ...
  #Menu pila      
    ...
    while True:
      try:
        lim=int(input("¿De cuantos elementos será la pila?: ")) 
        break
      except ValueError:
    ...
    while opc2 != "6":
      ...
      if opc2 == "1":
        ...
        datos.ingresar()
        input("Dato ingresado, presione una tecla para continuar...")
  ...
  #Menu Cola
    ...
    while True:
          try:
            lim=int(input("¿De cuantos elementos será la cola?: "))
            break
          except ValueError:
    ...
    while opc3 != "6":
      ...
      if opc3 == "1":
        ...
        datos.ingresar()
        input("Datos ingresados, presione una tecla para continuar...")
